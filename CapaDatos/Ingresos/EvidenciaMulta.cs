...
{
    public partial class EvidenciaMulta : SqlConnecion, IDisposable
    {
        private long _Id_Multa;
        private MultaUTT _MultaUTT;
        ...
        public MultaUTT Multa
        {
            get
            {
                if (_MultaUTT != null && _MultaUTT.Id_Multa != 0)
                    return _MultaUTT;
                else if (_Id_Multa != 0)
                    return _MultaUTT = new MultaUTT(_Id_Multa);
                else
                    return null;
            }
        }
        ...
        {
            return String.Format("SELECT Id_Evidencia, Id_Multa, Descripcion, Url, Tipo, FechaHora_Reg FROM EVIDENCIA_MULTA");
        }
        ...
        {
            return String.Format("INSERT INTO EVIDENCIA_MULTA (Id_Multa, Descripcion, Url, Tipo, FechaHora_Reg) " +
        ...
        {
            return String.Format("DELETE FROM EVIDENCIA_MULTA WHERE Id_Evidencia = {0};", ID);
        }
        ...
        {
            return String.Format("UPDATE EVIDENCIA_MULTA SET Id_Multa = {1}, Descripcion = {2}, Url = {3}, Tipo = {4}, FechaHora_Reg = '{5}' " +
