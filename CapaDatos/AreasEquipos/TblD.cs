...
{
    public partial class TblD : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblD");
        }
        ...
        public static TblD GetArea(long id)
        {
            return new TblD(id);
        }
        ...
        {
            return "DELETE FROM TblD " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblD (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblD WHERE Id = {0};", ID);
        }
