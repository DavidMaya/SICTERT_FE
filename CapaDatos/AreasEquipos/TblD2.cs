...
{
    public partial class TblD2 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblD2");
        }
        ...
        public static TblD2 GetArea(long id)
        {
            return new TblD2(id);
        }
        ...
        {
            return "DELETE FROM TblD2 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblD2 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblD2 WHERE Id = {0};", ID);
        }
