...
{
    public partial class TblC1 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblC1");
        }
        ...
        public static TblC1 GetArea(long id)
        {
            return new TblC1(id);
        }
        ...
        {
            return "DELETE FROM TblC1 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblC1 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblC1 WHERE Id = {0};", ID);
        }
