...
{
    public partial class TblB : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblB");
        }
        ...
        public static TblB GetArea(long id)
        {
            return new TblB(id);
        }
        ...
        {
            return "DELETE FROM TblB " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblB (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblB WHERE Id = {0};", ID);
        }
