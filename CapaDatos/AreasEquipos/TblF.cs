...
{
    public partial class TblF : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id,Instruccion FROM TblF");
        }
        ...
        public static TblF GetArea(long id)
        {
            return new TblF(id);
        }
        ...
        {
            return "DELETE FROM TblF " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblF (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblF WHERE Id = {0};", ID);
        }
