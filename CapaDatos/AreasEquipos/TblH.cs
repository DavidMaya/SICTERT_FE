...
{
    public partial class TblH : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblH");
        }
        ...
        public static TblH GetArea(long id)
        {
            return new TblH(id);
        }
        ...
        {
            return "DELETE FROM TblH " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblH (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblH WHERE Id = {0};", ID);
        }
