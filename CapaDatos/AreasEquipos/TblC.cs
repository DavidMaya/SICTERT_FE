...
{
    public partial class TblC : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblC");
        }
        ...
        public static TblC GetArea(long id)
        {
            return new TblC(id);
        }
        ...
        {
            return "DELETE FROM TblC " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblC (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblC WHERE Id = {0};", ID);
        }
