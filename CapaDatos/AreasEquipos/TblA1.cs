...
{
    public partial class TblA1 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblA1");
        }
        ...
        public static TblA1 GetArea(long id)
        {
            return new TblA1(id);
        }
        ...
        {
            return "DELETE FROM TblA1 "+((TAG!="")?String.Format("WHERE Instruccion LIKE '%{0}%';", TAG):"");
        }
        ...
        {
            return String.Format("INSERT INTO TblA1 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblA1 WHERE Id = {0};", ID);
        }
