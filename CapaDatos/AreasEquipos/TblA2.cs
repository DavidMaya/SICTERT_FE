...
{
    public partial class TblA2 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblA2");
        }
        ...
        public static TblA2 GetArea(long id)
        {
            return new TblA2(id);
        }
        ...
        {
            return "DELETE FROM TblA2 "+((TAG!="")?String.Format("WHERE Instruccion LIKE '%{0}%';", TAG):"");
        }
        ...
        {
            return String.Format("INSERT INTO TblA2 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblA2 WHERE Id = {0};", ID);
        }
