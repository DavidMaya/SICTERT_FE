...
{
    public partial class TblG : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblG");
        }
        ...
        public static TblG GetArea(long id)
        {
            return new TblG(id);
        }
        ...
        {
            return "DELETE FROM TblG " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblG (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblG WHERE Id = {0};", ID);
        }
