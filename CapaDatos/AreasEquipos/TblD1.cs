...
{
    public partial class TblD1 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblD1");
        }
        ...
        public static TblD1 GetArea(long id)
        {
            return new TblD1(id);
        }
        ...
        {
            return "DELETE FROM TblD1 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblD1 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblD1 WHERE Id = {0};", ID);
        }
