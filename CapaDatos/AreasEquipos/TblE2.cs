...
{
    public partial class TblE2 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblE2");
        }
        ...
        public static TblE2 GetArea(long id)
        {
            return new TblE2(id);
        }
        ...
        {
            return "DELETE FROM TblE2 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblE2 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblE2 WHERE Id = {0};", ID);
        }
