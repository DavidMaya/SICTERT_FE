...
{
    public partial class TblE1 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblE1");
        }
        ...
        public static TblE1 GetArea(long id)
        {
            return new TblE1(id);
        }
        ...
        {
            return "DELETE FROM TblE1 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblE1 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblE1 WHERE Id = {0};", ID);
        }
