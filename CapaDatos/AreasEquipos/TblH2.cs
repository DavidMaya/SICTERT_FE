...
{
    public partial class TblH2 : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblH2");
        }
        ...
        public static TblH2 GetArea(long id)
        {
            return new TblH2(id);
        }
        ...
        {
            return "DELETE FROM TblH2 " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblH2 (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblH2 WHERE Id = {0};", ID);
        }
