...
{
    public partial class TblE : SqlConnecion, IDisposable
    {
        ...
        {
            return String.Format("SELECT Id, Instruccion FROM TblE");
        }
        ...
        public static TblE GetArea(long id)
        {
            return new TblE(id);
        }
        ...
        {
            return "DELETE FROM TblE " + ((TAG != "") ? String.Format("WHERE Instruccion like '%{0}%';", TAG) : "");
        }
        ...
        {
            return String.Format("INSERT INTO TblE (Instruccion) " +
        ...
        {
            return String.Format("DELETE FROM TblE WHERE Id = {0};", ID);
        }
