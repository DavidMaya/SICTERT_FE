...
{
    public partial class ControlBioseguridadUTTDetalle : SqlConnecion, IDisposable
    {
        ...
        public ControlBioseguridadUTTDetalle()
        {
        }
        ...
        public ControlBioseguridadUTTDetalle(long idC, long idPC)
        {
        ...
        {
            return String.Format("SELECT Id_Control, Id_ParamControl, Aprobado FROM CONTROL_BIO_UTT_DETALLE");
        }
        ...
        {
            string sql = SqlServer.GetFormatoSQLNEXT("Id_Control", "CONTROL_BIO_UTT_DETALLE", "");
        ...
        {
            return String.Format("INSERT INTO CONTROL_BIO_UTT_DETALLE (Id_Control, Id_ParamControl, Aprobado) " +
        ...
        {
            return String.Format("DELETE FROM CONTROL_BIO_UTT_DETALLE WHERE Id_Control = {0} AND Id_ParamControl = {1};", ID, idPC);
        }
        ...
        {
            return String.Format("UPDATE CONTROL_BIO_UTT_DETALLE SET Aprobado = '{2}' " +
